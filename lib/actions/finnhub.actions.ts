...
// Minimal FinnhubProfile type to satisfy usage in this file.
// Expand fields as needed based on the actual API response.
interface FinnhubProfile {
  name?: string;
  ticker?: string;
  exchange?: string;
  // allow other properties from the API without strict typing
      ...
      if (!trimmed) {
        ...
        results = profiles
          .map(({ sym, profile }) => {
            ...
            (r as FinnhubSearchResult & { __exchange?: string }).__exchange =
